...
export interface IActiveMultisigContext extends ISharedAddressBooks {
  setActiveMultisigContextState: React.Dispatch<
    React.SetStateAction<IActiveMultisigContext>
  >
}
...
export const ActiveMultisigProvider = ({
  children,
  ...
  return (
    <ActiveMultisigContext.Provider
      value={{ ...activeMultisigContextState, setActiveMultisigContextState }}
    >
      {children}
    </ActiveMultisigContext.Provider>
  )
