    ...
    return (
      <>
        <Button
          ...
          size="large"
          className={
            "outline-none border-none text-xs md:text-sm font-medium bg-primary text-white rounded-md md:rounded-lg flex items-center gap-x-3"
          }
        >
          <PlusCircleOutlined />
      ...
      {!userAddress ? (
        <section className="mb-4 text-sm border-2 border-solid border-waiting w-full text-waiting bg-waiting bg-opacity-10 p-2.5 rounded-lg flex items-center gap-x-2">
          <p className="text-white">
            Looks like you are not Logged in. Please Log in to use our Features.
          </p>
        </section>
      ) : (
        <>
          <div className="bg-bg-main p-5 rounded-xl relative overflow-hidden">
            ...
            <section className="mb-4 text-sm w-full text-waiting bg-waiting bg-opacity-10 p-2.5 rounded-lg font-normal flex items-center gap-x-2">
              <p>
                Categories enable your team to organize payments and
                transactions with context, such as tags, dates, attachments,
                etc. They generate financial reports, offer insights, and
                facilitate filtering, sorting, and searching of financial data.
                You can customize category names and data types to suit your
