...
import { EFieldType, IDropdownOptions } from "@frontend/types"
import {
  DeleteIcon,
  EditIcon,
  OutlineCloseIcon,
  ...
  return (
    <div className="text-sm font-medium leading-[15px] ">
      ...
      {category === "none" ? (
        ...
        !Object.keys(transactionFields[category].subfields).length ? (
        <section className="my-4 text-sm w-full text-white font-normal flex justify-center">
                ...
                <div className="grid grid-cols-5 gap-x-5 py-6 px-4 text-white">
                  ...
                  <div className="col-span-1 flex items-center gap-x-[10px]">
                    <Switch
                      disabled={loading}
                      onChange={(checked) =>
                        handleRequiredChange(subfield, checked)
                      }
                      size="small"
