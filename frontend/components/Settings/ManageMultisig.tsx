...
import Details from "@frontend/components/Settings/Details"
import Feedback from "@frontend/components/Settings/Feedback"
import AddNewOwnerBtn from "@frontend/components/Settings/Owners/AddBtn"
import ListOwners from "@frontend/components/Settings/Owners/List"
      ...
      {!multisigAddresses || !multisig ? (
        <section className="mb-4 text-sm border-2 border-solid border-waiting w-full text-waiting bg-waiting bg-opacity-10 p-2.5 rounded-lg flex items-center gap-x-2">
          <p className="text-white">
            Looks Like You Don&apos;t have a Multisig. Please Create One to use
            our Features.
          </p>
        </section>
      ) : (
            ...
            <section className="flex items-center justify-between flex-col gap-5 md:flex-row mb-6">
              <div className="bg-bg-secondary rounded-lg p-3 w-auto flex items-center gap-x-4">
                <div className="flex flex-col items-start">
                  <div
                    className={
                      "px-2 mb-1 py-[2px] rounded-md text-xs font-medium bg-primary text-white"
                    }
                  >
                    Multisig
                  </div>
