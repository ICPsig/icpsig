...
const QR = () => {
	return (
		<div className='flex flex-col gap-y-5 p-5 bg-bg-secondary rounded-xl items-center'>
			...
			<div className='flex items-center justify-center'>{/* <AddressQr address='165gUhnbTdZEfjY4drYNybJuRBf3MLJfZxQUraJDeX17B4Pb' /> */}</div>
			<div className='flex items-center gap-x-3 justify-center bg-highlight rounded-lg p-2'>
				<p className='text-xs md:text-sm leading-[15px]'>
					...
					<span className='font-normal ml-[6px]'>{shortenAddress('165gUhnbTdZEfjY4drYNybJuRBf3MLJfZxQUraJDeX17B4Pb')}</span>
				</p>
